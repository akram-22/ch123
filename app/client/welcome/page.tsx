...
const STATUS_ITEMS = [
  {
    icon: Wifi,
    label: '5 dispositifs Mainteligence Sense déployés',
    color: '#3b82f6',
  ...
  {
    icon: Cpu,
    label: '5 machines connectées et surveillées',
    color: '#e8650a',
  ...
  {
    icon: Activity,
    label: 'Surveillance en temps réel activée',
    color: '#10b981',
  ...
  {
    icon: ShieldCheck,
    label: 'Système de prédiction IA actif',
    color: '#a78bfa',
      ...
      >
        ...
        {/* Main heading */}
          ...
          <p className="text-sm text-[#52525b] leading-relaxed max-w-md text-pretty">
            Surveillez vos actifs industriels en temps réel avec la maintenance prédictive pilotée par IA
          </p>
        </div>
        ...
        <div className="w-full bg-[#0d0d0f] border border-[#1c1c1f] rounded-sm p-1 overflow-hidden">
          ...
          <div className="flex items-center gap-2 px-4 py-2.5 border-b border-[#1c1c1f]">
            ...
            <span className="text-[9px] font-mono uppercase tracking-[0.2em] text-[#52525b]">Statut du système</span>
            <div className="ml-auto flex items-center gap-1.5">
              <PulseDot color="#10b981" />
              <span className="text-[9px] font-mono text-[#10b981]">Tous les systèmes opérationnels</span>
            </div>
          </div>
