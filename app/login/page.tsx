...
const DEMO_ACCOUNTS = [
  { label: 'Sonatrach — Pétrole & Gaz (Entreprise)', email: 'alpha@mainteligence.demo', password: 'demo123' },
  { label: 'Cevital Industries — Agro-Industriel (Professionnel)', email: 'beta@mainteligence.demo', password: 'beta2025' },
  { label: 'Lafarge Algérie — Ciment (Démarrage)', email: 'gamma@mainteligence.demo', password: 'gamma2025' },
]
    ...
    <div className="min-h-screen bg-[#09090b] flex flex-col">
      ...
      <header className="h-16 border-b border-[#1c1c1f] flex items-center px-8">
        ...
        <div className="ml-auto flex items-center gap-1.5 text-[10px] font-mono text-[#3a3a3d]">
          ...
          <span>Accès client sécurisé</span>
        </div>
      </header>
          ...
          <div className="bg-[#111113] border border-[#1c1c1f] rounded-sm p-8">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm text-[#52525b] mt-1.5 leading-relaxed">
                Accédez à la plateforme de surveillance industrielle privée de votre entreprise.
              </p>
            </div>
              ...
              <div className="flex flex-col gap-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    onClick={() => alert('Contactez votre gestionnaire de compte Mainteligence pour réinitialiser votre mot de passe.')}
                  >
                    Mot de passe oublié ?
                  </button>
                </div>
            ...
            <div className="flex items-center gap-3 my-6">
              ...
              <span className="text-[10px] font-mono text-[#27272a]">COMPTES DÉMO</span>
              <div className="flex-1 h-px bg-[#1c1c1f]" />
            </div>
