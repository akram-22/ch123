...
const I18N_FALLBACK: I18nContextType = {
  lang: 'en',
  setLang: () => {},
...
export function useI18n(): I18nContextType {
  ...
  // Return a safe fallback instead of throwing — prevents blank-screen crash
  // when the hook is called outside the provider tree (SSR edge case).
